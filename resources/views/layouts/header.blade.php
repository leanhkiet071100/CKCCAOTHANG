<div class="topbar stick">
            <div class="logo">
                <a title="" href="{{route('newfeed')}}"><img style="width:22%" src="http://127.0.0.1:8000/assets/images/logoCKCSocialNetwork.png" alt=""></a>
            </div>
                ...
                <ul class="main-menu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="http://127.0.0.1:8000/caidat/thaydoithongtincanhan" title="">Thay đổi thông tin cá nhân</a></li>
                            <li><a href="http://127.0.0.1:8000/caidat/thaydoimatkhau" title="">Thay đổi mật khẩu</a></li>
